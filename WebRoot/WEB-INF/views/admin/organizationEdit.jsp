...
<script type="text/javascript">
	...
	$("#isaccount").val('${organization.isaccount}');
	});
</script>
<div style="padding: 3px;">
	<form id="organizationEditForm" method="post">
		<table class="grid">
			...
			<tr>
				<td>排序</td>
				<td><input name="seq"  class="easyui-numberspinner" value="${organization.seq}" style="widtd: 140px; height: 29px;" required="required" data-options="editable:true"></td>
				<td>菜单图标</td>
				<td ><input  name="icon" value="${organization.icon}"/></td>
			</tr>
			<tr>
				<td>核算单位简称</td>
				<td><input name="shortname" type="text"  class="easyui-validatebox" value="${organization.shortname}" style="width: 140px; height: 29px;" validType="length[0,2]"></td>
				<td>是否核算单位</td>
