...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="meetingViewForm" method="post">
            <table class="grid"  style="border-collapse: separate; border-spacing: 3px; ">
                ...
                <tr>
                    ...
                    <td>会议名称</td>
                    <td><input id="meetname" readonly  name="meetname" style="height:30px;width:200px;" class="easyui-textbox" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <th>会议开始时间:</th>
                    <td>
                ...
                <tr>
                    <th>会议室:</th>
                    <td>
                    <select disabled id = "meetingroom" readonly  name="meetingroom" style="height:30px;width:200px;">
                    ...
                    <th>发起人:</th>
                    <td>
                    <select disabled  id="userid" style="height:30px;width:200px;" name="userid"  >
                ...
                <tr>
                    <td>与会人员</td>
                    <td>
                    <input readonly id="meetingperson" class="easyui-textbox" style="width:200px;height:60px;"
                     name="meetingperson" data-options="multiline:true,prompt:'必须输入(人员以逗号隔开)', required:true" value=""/>
                    </td>
                    
                    <td>备注</td>
                    <td><input readonly id="comments" name="comments"  class="easyui-textbox" style="width:200px;height:60px;" data-options="multiline:true" value=""/></td>
                </tr>
                <tr>
                	<td>文件是否预览</td>
                	<td>
                		<select id="isView" name="isView" class="easyui-combobox" data-options="readonly:true,width:200,height:29,editable:false,panelHeight:'auto'">
